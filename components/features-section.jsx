    ...
    <motion.div
      ...
      <motion.div
        ...
        className="h-full w-1/3 rounded-2xl bg-black p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
          ...
          <IconRocket className="h-8 w-8 text-neutral-200" />
        <p
      ...
      <motion.div
        className="h-full relative z-20 w-1/3 rounded-2xl bg-black p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
          <IconUsers className="h-8 w-8 text-neutral-200" />
        
        <p
          className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          Commit while using Chatbot 
        </p>
        <p
      ...
      <motion.div
        variants={second}
        className="h-full w-1/3 rounded-2xl bg-black p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
          <IconSettings className="h-8 w-8 text-neutral-200" />
        
        <p
          className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          Local and remote editing
        </p>
        <p
  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        <Icon3dCubeSphereOff className="h-8 w-8 text-neutral-200" />

        <p className="text-xs text-neutral-500">
        Use GitHub for everything. Use the chatbot to manage your repositories.
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
        ...
        <p className="text-xs text-neutral-500">Automate Git</p>
        <div
          className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 shrink-0" />
      </motion.div>
    </motion.div>
...
const items = [
  ...
  {
    title: "Instant GitHub Commits",
    description: (
      <span className="text-sm">
        Commit code instantly through the chatbot. No more switching tabs or staging files.
      </span>
    ),
    header: <SkeletonTwo />,
    className: "md:col-span-1",
  ...
  {
    title: "Prompt-Based Project Automation",
    description: (
      <span className="text-sm">
        Generate and commit entire projects to GitHub using just a prompt—no editor required.
      </span>
    ),
  ...
  {
    title: "GitHub & Local Sync",
    description: (
      <span className="text-sm">
        Choose to edit locally or push directly to GitHub. Flexibility built in.
      </span>
    ),
    header: <SkeletonFour />,
  ...
  {
    title: "Chat-Driven DevOps",
    description: (
      <span className="text-sm">
        Manage repos, branches, and deployments by simply chatting with the bot.
      </span>
    ),
    header: <SkeletonFive />,
    className: "md:col-span-1",
