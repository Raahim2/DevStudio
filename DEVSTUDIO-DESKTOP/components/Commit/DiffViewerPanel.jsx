...
const DiffViewerPanel = ({
    ...
    return (
        <div className="flex-1 overflow-auto p-1 bg-white" style={{fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace', fontSize: '12px', lineHeight: '1.5'}}>
             {selectedFileForDiff ? (
                 isLoadingError ? (
                      <div className="h-full flex items-center justify-center text-red-500 p-4 text-sm">
                    ...
                    />
                      ...
                      <div className="h-full flex items-center justify-center text-gray-400 p-4 text-sm">
                         <FiAlertCircle className="mr-2"/> No differences to display for this file state.
                     </div>
                 )
             ) : (
                 <div className="h-full flex flex-col items-center justify-center text-gray-500 p-4">
                    <FiGitBranch size={32} className="mb-2 text-gray-400"/>
